...
class NBAGameState(BaseModel):
    ...
    clock_time: Optional[str] = Field(None, description="Time remaining in the current quarter, e.g., '9:09'")
    shot_clock: Optional[int] = Field(None, description="Shot clock time remaining")
