...
<td> <pre>{<br>  "description": "The Kindle Paperwhite features a 6.8-inch display with adjustable warm light, offering a larger screen and enhanced reading experience.",<br>  "rating": 90,<br>  "name": "Kindle Paperwhite (8 GB)",<br>  "brand": "Amazon",<br>  "category": "Electronics / E-readers",<br>  "price": "$139.99",<br>  "color": "Black"<br>}</pre> </td>
